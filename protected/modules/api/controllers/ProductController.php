...
class ProductController extends ApiController
{
	...
	public function actionInfo($id='',$openid='')
	{
		...
		$nowdata = [];
		foreach (['id','name','image','area_name','street_name','tags','zz','company','pf','hits','work_year','content','place','price_note','price','off_price','times','comments','phone','sex','wx'] as $key => $value) {
