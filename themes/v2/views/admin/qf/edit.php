...
<div class="form-group">
    <label class="col-md-2 control-label">群发对象<span class="required" aria-required="true">*</span></label>
    <?php $arr = []; $phones = Yii::app()->db->createCommand("select phone from user where status=1 and type=2")->queryAll();if($phones) {
      foreach ($phones as $key => $value) {
       $arr[] = $value['phone'];
      }
      } ?>
    <div class="col-md-4">
        <?php echo $form->textArea($article, 'phones', array('class' => 'form-control','value'=>implode(',', $arr))); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'phones') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">群发内容<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textArea($article, 'note', array('class' => 'form-control','placeholder'=>'最多19个字')); ?>
    </div>
